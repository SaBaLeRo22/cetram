				...
				<div class="form-horizontal">
					<fieldset class="inputs">
						...
						<div class="string control-group stringish" id="Localidad">
							<?php echo $this->Form->input('localidad_id', array('empty' => '', 'label'=>array('text'=>__('Localidad'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">'.'Localidad Actual: '.$user['Localidad'][nombre].' - CP: '.$user['Localidad'][codigopostal].'</span></div>'));?>
						</div>
