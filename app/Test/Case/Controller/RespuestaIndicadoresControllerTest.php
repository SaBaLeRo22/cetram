<?php
App::uses('RespuestaIndicadoresController', 'Controller');

/**
 * RespuestaIndicadoresController Test Case
 *
 */
class RespuestaIndicadoresControllerTest extends ControllerTestCase {
