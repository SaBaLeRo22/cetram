<?php
App::uses('RespuestaParametrosController', 'Controller');

/**
 * RespuestaParametrosController Test Case
 *
 */
class RespuestaParametrosControllerTest extends ControllerTestCase {
