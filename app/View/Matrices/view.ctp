...
?><div class="row matrices view">
    ...
    <div class="col-md-4">
		...
		<?= $this->Form->postLink(__('Eliminar Matrix'), array('action' => 'eliminar', $matrix['Matrix']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $matrix['Matrix']['id'])); ?>
    ...
    <div class="col-md-8">
		<div class="well well-sm">
			...
			<dl class="dl-horizontal text-muted">
				...
				<dd>
					<?= h($this->Authake->getUsuario($matrix['Matrix']['user_created'])); ?>
					&nbsp;
				</dd>
				<dt>Created</dt>
				...
				<dd>
					<?= h($this->Authake->getUsuario($matrix['Matrix']['user_modified'])); ?>
					&nbsp;
				</dd>
				<dt>Modified</dt>
