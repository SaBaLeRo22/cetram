...
?><div class="row tipos view">
    ...
    <div class="col-md-4">
		...
		<?= $this->Form->postLink(__('Eliminar Tipo'), array('action' => 'eliminar', $tipo['Tipo']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $tipo['Tipo']['id'])); ?>
    ...
    <div class="col-md-8">
		...
		<tr>
			...
			<td><?= $this->Authake->getUsuario($item['user_created']); ?></td>
			<td><?= $this->Authake->getUsuario($item['user_modified']); ?></td>
			...
			<td class="actions">
				...
				<?= $this->Form->postLink(__('Eliminar'), array('controller' => 'items', 'action' => 'eliminar', $item['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $item['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
                </tbody>
		...
		<tr>
			...
			<td><?= $parametro['Unidade']['nombre']; ?></td>
			<td><?= $parametro['Ambito']['nombre']; ?></td>
			<td><?= $parametro['Estado']['nombre']; ?></td>
			<td><?= $parametro['created']; ?></td>
			<td><?= $parametro['modified']; ?></td>

			<td><?= $this->Authake->getUsuario($parametro['user_created']); ?></td>
			<td><?= $this->Authake->getUsuario($parametro['user_modified']); ?></td>
			...
			<td class="actions">
				...
				<?= $this->Form->postLink(__('Eliminar'), array('controller' => 'parametros', 'action' => 'eliminar', $parametro['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $parametro['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
                </tbody>
