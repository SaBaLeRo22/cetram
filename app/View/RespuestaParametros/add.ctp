 ...
 * @var $this View
 */
?><div class="row respuestaParametros form">
    <div class="col-md-9">
                <h2><?= __('Editar Respuesta Parametro') ?></h2>
                <hr/>

        <?= $this->Form->create('RespuestaParametro', array('class' => 'form-horizontal')); ?>
            ...
            <?= $this->Form->input('parametro_id'); ?> 
                                                    ...
                                                    <div class="form-group">
            <?= $this->Form->label('parametro', null, array('class' => 'control-label col-xs-3')); ?> 
            <?= $this->Form->input('parametro'); ?> 
        </div>
                                                    <div class="form-group">
