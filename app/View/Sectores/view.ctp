    ...
    <div class="col-md-4">
        ...
        <div class="actions">
            ...
            <div class="list-group">
                                		<?= $this->Html->link(__('Editar Sectore'), array('action' => 'edit', $sectore['Sectore']['id']), array('class' => 'list-group-item')); ?> 
		<?= $this->Form->postLink(__('Eliminar Sectore'), array('action' => 'delete', $sectore['Sectore']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $sectore['Sectore']['id'])); ?> 
