        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('inio'); ?></th>
                ...
                <tr>
                    <td><?= h($convenio['Convenio']['id']); ?>&nbsp;</td>
                    <td class="display-column">
                        <?= $this->Html->link( h( $convenio['Convenio']['anio'] ),
                        array( 'action' => 'view', $convenio['Convenio']['id'] ) ); ?>                        
                        <div class="nowrap">
