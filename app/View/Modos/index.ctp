                ...
                <tr>
                    ...
                    <td class="display-column">
                        ...
                        <div class="nowrap">
                            ...
                            &nbsp;
                            <?= $this->Form->postLink( '<i class="fa fa-trash"></i> Eliminar', array('action' => 'delete', $modo['Modo']['id']), array('class' => 'btn btn-danger btn-xs'), __('Se va a eliminar %s ¿Está seguro de eliminar este registro?', $modo['Modo']['nombre'])); ?>                 
                        </div>
                    </td> 
                    <td><?= h($modo['Modo']['descripcion']); ?>&nbsp;</td>
                    <td><?= $modo['Estado']['nombre']; ?></td><td><?= h($modo['Modo']['created']); ?>&nbsp;</td>
                    <td><?= h($modo['Modo']['modified']); ?>&nbsp;</td>
                    <td><?= h($modo['Modo']['user_created']); ?>&nbsp;</td>
                    <td><?= h($modo['Modo']['user_modified']); ?>&nbsp;</td>
