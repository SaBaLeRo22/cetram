    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Multiplicadore.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('Multiplicadore.nombre'))); ?>                                <?= $this->Html->link(__('Listado de Multiplicadores'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
