    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'eliminar', $this->Form->value('Categoria.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('Categoria.nombre'))); ?>                                <?= $this->Html->link(__('Listado de Categorias'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
