    ...
    <div class="col-md-4">
        ...
        <div class="actions">
            ...
            <div class="list-group">
                                		<?= $this->Html->link(__('Editar Opcion'), array('action' => 'edit', $opcione['Opcione']['id']), array('class' => 'list-group-item')); ?>
		<?= $this->Form->postLink(__('Eliminar Opcion'), array('action' => 'eliminar', $opcione['Opcione']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $opcione['Opcione']['id'])); ?>
		<?= $this->Html->link(__('Listado de Opciones'), array('action' => 'index'), array('class' => 'list-group-item')); ?> 
		<?= $this->Html->link(__('Agregar Opcion'), array('action' => 'add'), array('class' => 'list-group-item')); ?>
            </div>
        </div>
    </div>
    <div class="col-md-8">
