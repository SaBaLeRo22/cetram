    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'eliminar', $this->Form->value('Opcione.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('Opcione.opcion'))); ?>                                <?= $this->Html->link(__('Listado de Opciones'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
