	...
	<div class="col-md-4">
		<div class="actions">
			...
			<div class="list-group">
				<?= $this->Html->link(__('Editar Intervencion'), array('action' => 'edit', $intervencione['Intervencione']['id']), array('class' => 'list-group-item')); ?>
				<?= $this->Form->postLink(__('Eliminar Intervencion'), array('action' => 'eliminar', $intervencione['Intervencione']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $intervencione['Intervencione']['id'])); ?>
				<?= $this->Html->link(__('Listado de Intervenciones'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
				<?= $this->Html->link(__('Agregar Intervencion'), array('action' => 'add'), array('class' => 'list-group-item')); ?>
			</div>
		</div>
	</div>
    <div class="col-md-8">
		...
		<dd>
            ...
            <dl class="dl-horizontal text-muted">
				...
				<dd>
					<?= h($this->Authake->getUsuario($intervencione['Intervencione']['user_created'])); ?>
					&nbsp;
				</dd>
                <dt>Created</dt>
				...
				<dd>
					<?= h($this->Authake->getUsuario($intervencione['Intervencione']['user_modified'])); ?>
					&nbsp;
				</dd>
                <dt>Modified</dt>
