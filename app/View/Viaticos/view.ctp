...
?><div class="row viaticos view">
    ...
    <div class="col-md-4">
		...
		<?= $this->Form->postLink(__('Eliminar Viatico'), array('action' => 'delete', $viatico['Viatico']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $viatico['Viatico']['id'])); ?> 
