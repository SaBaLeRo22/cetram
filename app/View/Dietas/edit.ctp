    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Dieta.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('Dieta.nombre'))); ?>                                <?= $this->Html->link(__('Listado de Dietas'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
