    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('RespuestaItem.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('RespuestaItem.valor'))); ?>                                <?= $this->Html->link(__('Listado de Respuesta Items'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
