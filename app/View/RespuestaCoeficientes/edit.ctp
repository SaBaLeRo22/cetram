 ...
 * @var $this View
 */
?><div class="row respuestaCoeficientes form">
    <div class="col-md-9">
                <h2><?= __('Editar Respuesta Coeficiente') ?></h2>
                <hr/>

        <?= $this->Form->create('RespuestaCoeficiente', array('class' => 'form-horizontal')); ?>
        ...
        <?= $this->Form->input('id'); ?>  
            ...
            <?= $this->Form->input('coeficiente_id'); ?> 
                                                    ...
                                                    <div class="form-group">
            <?= $this->Form->label('coeficiente', null, array('class' => 'control-label col-xs-3')); ?> 
            <?= $this->Form->input('coeficiente'); ?> 
        </div>
                                                    <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('RespuestaCoeficiente.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('RespuestaCoeficiente.valor'))); ?>                                <?= $this->Html->link(__('Listado de Respuesta Coeficientes'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
