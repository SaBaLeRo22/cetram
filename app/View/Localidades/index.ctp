        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('codigopostal', 'CP'); ?></th>
                ...
                <tr>
                    ...
                    <td><?= $localidade['Provincia']['nombre']; ?></td><td class="display-column">
                        ...
                        <div class="nowrap">
                            ...
                            &nbsp;
                            <?= $this->Form->postLink( '<i class="fa fa-trash"></i> Eliminar', array('action' => 'eliminar', $localidade['Localidade']['id']), array('class' => 'btn btn-danger btn-xs'), __('Se va a eliminar %s ¿Está seguro de eliminar este registro?', $localidade['Localidade']['nombre'])); ?>
                        </div>
                    </td> 
