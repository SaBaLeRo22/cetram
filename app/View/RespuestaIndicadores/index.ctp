        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('alerta_id'); ?></th>
                ...
                <tr>
                    ...
                    <td><?= $respuestaIndicadore['Consulta']['costo']; ?></td><td><?= $respuestaIndicadore['Indicadore']['nombre']; ?></td><td><?= h($respuestaIndicadore['RespuestaIndicadore']['alerta_id']); ?>&nbsp;</td>
                    <td><?= h($respuestaIndicadore['RespuestaIndicadore']['evento_id']); ?>&nbsp;</td>
                    <td><?= h($respuestaIndicadore['RespuestaIndicadore']['indicador']); ?>&nbsp;</td>
