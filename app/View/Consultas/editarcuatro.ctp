...
?><div class="row consultas form">
    <div class="col-md-12">
        <h1>Editar <small>Paso 4 de 6</small></h1>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <?= $this->Form->input('Consulta.preguntas.'.$pregunta['Pregunta']['id'], array('required' => 'required', 'div'=>false, 'type' => $pregunta['Pregunta']['tipo'],'options' => $pregunta['Pregunta']['opciones'], 'step' => $pregunta['Pregunta']['step'], 'min' => $pregunta['Pregunta']['minimo'], 'max' => $pregunta['Pregunta']['maximo'])); ?>
            </div>
        </div>
