...
<div class="row consultas view">
	<div class="col-md-12">
		...
		<div class="related">
			...
			<div class="row consultas view">
			<div class="col-md-4 card text-white bg-success mb-3" style="max-width: 20rem;">
			...
			<div class="col-md-4 card text-white bg-danger mb-3" style="max-width: 20rem;">
				<div class="card-header">Header</div>
				<div class="card-body">
			...
			<div class="col-md-4 card text-white bg-warning mb-3" style="max-width: 20rem;">
				<div class="card-header">Header</div>
				<div class="card-body">
