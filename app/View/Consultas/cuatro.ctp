...
?><div class="row consultas form">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <?= $this->Form->input('Consulta.preguntas.'.$pregunta['Pregunta']['id'], array('div'=>false, 'type' => $pregunta['Pregunta']['tipo'],'options' => $pregunta['Pregunta']['opciones'], 'step' => $pregunta['Pregunta']['step'], 'min' => $pregunta['Pregunta']['minimo'], 'max' => $pregunta['Pregunta']['maximo'])); ?>
            </div>
        </div>
