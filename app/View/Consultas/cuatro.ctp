    ...
    <div class="col-md-12">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
                    <th style="vertical-align: middle; text-align: center"><h4 style="font-weight: bold">CATEGORIA</h4></th>
                    <th style="vertical-align: middle; text-align: center"><h4 style="font-weight: bold">CANTIDAD</h4></th>
                    <th style="vertical-align: middle; text-align: center"><h4 style="font-weight: bold">SALARIO ($)</h4></th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($salarios as $salario): ?>
                <tr>
                    <td class="info" style="vertical-align: middle; padding-bottom: 0;padding-top: 0;margin-top: 0;margin-bottom: 0"><h4 style="font-weight: bold"><?= h($salario['Categoria']['nombre']); ?>&nbsp;</h4></td>
