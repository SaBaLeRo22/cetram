...
?><div class="row consultas form">
    <div class="col-md-12">
        <h1>Realizar Consulta <small>Paso 4 de 6</small></h1>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <?= $this->Form->input('Consulta.preguntas.'.$pregunta['Pregunta']['id'], array('required' => 'required', 'default' => $pregunta['Pregunta']['minimo'], 'div'=>false, 'type' => $pregunta['Pregunta']['tipo'],'options' => $pregunta['Pregunta']['opciones'], 'step' => $pregunta['Pregunta']['step'], 'min' => $pregunta['Pregunta']['minimo'], 'max' => $pregunta['Pregunta']['maximo'])); ?>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-condensed table-striped" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="align-items:center; padding-bottom: 0;padding-top: 0"><?= $this->Form->input('Consulta.categorias.'.$categoria['Categoria']['id'].'.cantidad', array('style'=>'margin-top: 5%;align-items:center','div'=>false, 'type' => 'number','default' => '0', 'min' => '0')); ?>&nbsp;</td>
                    <td style="align-items:center; padding-bottom: 0;padding-top: 0"><?= $this->Form->input('Consulta.categorias.'.$categoria['Categoria']['id'].'.antiguedad', array('style'=>'margin-top: 5%;align-items:center','div'=>false, 'type' => 'number','default' => '0', 'step' => '0.01', 'min' => '0')); ?>&nbsp;</td>
                    <td style="vertical-align: middle; padding-bottom: 0;padding-top: 0"><?= $this->Form->input('Consulta.categorias.'.$categoria['Categoria']['id'].'.salario', array('style'=>'margin-top: 5%;align-items:center','div'=>false, 'type' => 'number','default' => '0', 'step' => '0.01', 'min' => '0')); ?>&nbsp;</td>
                </tr>
                <?php endforeach ?>
                </tbody>
                <tfoot>
