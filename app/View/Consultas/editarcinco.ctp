...
?><div class="row consultas form">
    <div class="col-md-12">
        ...
        <div class="form-group">
            <?= $this->Form->label($parametro['RespuestaParametro']['id'], $parametro['RespuestaParametro']['parametro'].' '.'('.$parametro['RespuestaParametro']['unidad'].')', array('class' => 'control-label col-xs-10')); ?>
            <div class="col-xs-2">
