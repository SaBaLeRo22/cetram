    ...
    <div class="col-md-3">
        <div class="actions">
            ...
            <div class="list-group">
                                                <?= $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('RespuestaPasajero.id')), array('class' => 'list-group-item'), __('Se va a eliminar %s ¿Confirma la eliminación?', $this->Form->value('RespuestaPasajero.tarifa'))); ?>                                <?= $this->Html->link(__('Listado de Respuesta Pasajeros'), array('action' => 'index'), array('class' => 'list-group-item')); ?>
                            </div>
