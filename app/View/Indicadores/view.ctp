    ...
    <div class="col-md-4">
		...
		<dd>
            ...
            <dl class="dl-horizontal text-muted">
				...
				<dd>
					<?= h($this->Authake->getUsuario($indicadore['Indicadore']['user_created'])); ?>
					&nbsp;
				</dd>
                <dt>Created</dt>
				...
				<dd>
					<?= h($this->Authake->getUsuario($indicadore['Indicadore']['user_modified'])); ?>
					&nbsp;
				</dd>
                <dt>Modified</dt>
        ...
        <div class="actions">
            ...
            <div class="list-group">
                                		<?= $this->Html->link(__('Editar Indicador'), array('action' => 'edit', $indicadore['Indicadore']['id']), array('class' => 'list-group-item')); ?>
		<?= $this->Form->postLink(__('Eliminar Indicador'), array('action' => 'eliminar', $indicadore['Indicadore']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $indicadore['Indicadore']['id'])); ?>
		<?= $this->Html->link(__('Listado de Indicadores'), array('action' => 'index'), array('class' => 'list-group-item')); ?> 
		<?= $this->Html->link(__('Agregar Indicador'), array('action' => 'add'), array('class' => 'list-group-item')); ?>
            </div>
        </div>
    </div>
    <div class="col-md-8">
