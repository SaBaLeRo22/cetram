...
?><div class="row salarios view">
    ...
    <div class="col-md-4">
		...
		<?= $this->Form->postLink(__('Eliminar Salario'), array('action' => 'eliminar', $salario['Salario']['id']), array('class' => 'list-group-item'), __('Are you sure you want to delete # %s?', $salario['Salario']['id'])); ?>
